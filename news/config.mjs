...
export const keywords = {
  ...
  topic: [
    '馬毛島', '辺野古', '普天間', '基地建設', '防衛施設', '自衛隊施設',
    '火薬庫', '弾薬庫', '司令部地下化', '掩体',
    '特定利用空港', '特定利用港湾', '防衛力整備計画', '強靱化', '強靭化',
    '米軍再編', 'キャンプ・シュワブ', '南西シフト',
    // 「施設整備」は入れない。「萩山小複合施設整備事業」のような
    // 防衛と無関係な公共工事に当たる。facility 側にはある。
  ],
  // 防衛の主体・領域を指す語
  // 場所や主体を指すだけの語。これだけでは通さない。
  //
  // 「駐屯地」「演習場」「基地負担」を topic に置いていたら、訓練の実施や
  // 知事選の報道まで通った。その場所で何かが起きた、というだけでは
  // 施設・建築土木の話にならない。施設側の語と組で初めて採る。
  defense: [
    '防衛省', '防衛局', '防衛装備庁', '自衛隊', '陸上自衛隊', '海上自衛隊',
    '航空自衛隊', '陸自', '海自', '空自', '米軍', '日米', '防衛大臣',
    '日米合同委員会', '国民保護', 'シェルター', '防衛関連',
    '駐屯地', '分屯地', '演習場', '基地', '在日米軍', '米軍基地', '嘉手納',
    '基地機能', '基地負担',
  ],
  // 施設・建築土木を指す語
  //
